...
export const SURFACE_INVENTORY: readonly SurfaceRoute[] = [
  ...
  },
  {
    ...
    method: 'GET',
    path: '/api/p2e/season',
    handler: 'server/p2e.ts seasonHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.public,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'server/p2e.ts openHeroBoxHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    method: 'GET',
    path: '/api/p2e/heroes',
    handler: 'server/p2e.ts heroesHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.bearer,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'server/p2e.ts starterHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
